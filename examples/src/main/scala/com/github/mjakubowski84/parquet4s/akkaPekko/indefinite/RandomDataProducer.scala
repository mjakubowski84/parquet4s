...
import com.github.mjakubowski84.parquet4s.ScalaCompat.actor.{
  Actor,
  ActorRef,
  Cancellable,
  CoordinatedShutdown,
...
import com.github.mjakubowski84.parquet4s.ScalaCompat.util.Timeout
