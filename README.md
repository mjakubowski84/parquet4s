...
libraryDependencies ++= Seq(
  "com.github.mjakubowski84" %% "parquet4s-core" % "1.9.0",
...
```scala
def ivyDeps = Agg(
  ivy"com.github.mjakubowski84::parquet4s-core:1.9.0",
...
```scala
"com.github.mjakubowski84" %% "parquet4s-akka" % "1.9.0"
"org.apache.hadoop" % "hadoop-client" % yourHadoopVersion
```
...
```scala
"com.github.mjakubowski84" %% "parquet4s-fs2" % "1.9.0"
"org.apache.hadoop" % "hadoop-client" % yourHadoopVersion
```
