...
class SkippingParquetSchemaResolverSpec extends AnyFlatSpec with Matchers {
  ...
  it should "skip a field at a long path" in {
    resolveSchema[Person](Set(Col("address.street.name"))) should be(
      Message(
        Some(classOf[Person].getCanonicalName),
        Types.primitive(BINARY, OPTIONAL).as(StringType).named("name"),
        Types.primitive(INT32, REQUIRED).as(Int32Type).named("age"),
  ...
  it should "skip a mid path" in {
    resolveSchema[Person](Set(Col("address.street"))) should be(
      Message(
        Some(classOf[Person].getCanonicalName),
        Types.primitive(BINARY, OPTIONAL).as(StringType).named("name"),
        Types.primitive(INT32, REQUIRED).as(Int32Type).named("age"),
  ...
  it should "skip all fields of case class" in {
    resolveSchema[Person](Set(Col("address.street.name"), Col("address.street.more"))) should be(
      Message(
        Some(classOf[Person].getCanonicalName),
        Types.primitive(BINARY, OPTIONAL).as(StringType).named("name"),
        Types.primitive(INT32, REQUIRED).as(Int32Type).named("age"),
  ...
  it should "skip a field at a long path" in {
    resolveSchema[RowParquetRecord](Set(Col("address.street.name"))) should be(
      Message(
        Some(classOf[Person].getCanonicalName),
        Types.primitive(BINARY, OPTIONAL).as(StringType).named("name"),
        Types.primitive(INT32, REQUIRED).as(Int32Type).named("age"),
  ...
  it should "skip a mid path" in {
    resolveSchema[RowParquetRecord](Set(Col("address.street"))) should be(
      Message(
        Some(classOf[Person].getCanonicalName),
        Types.primitive(BINARY, OPTIONAL).as(StringType).named("name"),
        Types.primitive(INT32, REQUIRED).as(Int32Type).named("age"),
  ...
  it should "skip all fields of case class" in {
    resolveSchema[RowParquetRecord](Set(Col("address.street.name"), Col("address.street.more"))) should be(
      Message(
        Some(classOf[Person].getCanonicalName),
        Types.primitive(BINARY, OPTIONAL).as(StringType).named("name"),
        Types.primitive(INT32, REQUIRED).as(Int32Type).named("age"),
