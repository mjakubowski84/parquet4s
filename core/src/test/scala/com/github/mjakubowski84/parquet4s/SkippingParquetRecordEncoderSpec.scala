...
class SkippingParquetRecordEncoderSpec extends AnyFlatSpec with Matchers {
  ...
  "SkippingParquetRecordEncoder" should "skip a field at a long path" in {
    encode(Set("address.street.name"), person) should be(
      RowParquetRecord(
        "name" -> "Joe",
        "age" -> 18,
        "address" -> RowParquetRecord(
  ...
  it should "skip a mid path" in {
    encode(Set("address.street"), person) should be(
      RowParquetRecord(
        "name" -> "Joe",
        "age" -> 18,
        "address" -> RowParquetRecord(
  ...
  it should "skip all fields of case class" in {
    encode(Set("address.street.name", "address.street.more"), person) should be(
      RowParquetRecord(
        "name" -> "Joe",
        "age" -> 18,
        "address" -> RowParquetRecord(
  ...
  "Generic SkippingParquetRecordEncoder" should "skip a field at a long path" in {
    encode(Set("address.street.name"), personRecord) should be(
      RowParquetRecord(
        "name" -> "Joe",
        "age" -> 18,
        "address" -> RowParquetRecord(
  ...
  it should "skip a mid path" in {
    encode(Set("address.street"), personRecord) should be(
      RowParquetRecord(
        "name" -> "Joe",
        "age" -> 18,
        "address" -> RowParquetRecord(
  ...
  it should "skip all fields of case class" in {
    encode(Set("address.street.name", "address.street.more"), personRecord) should be(
      RowParquetRecord(
        "name" -> "Joe",
        "age" -> 18,
        "address" -> RowParquetRecord(
