...
trait Stats {
  ...
  /** @param columnPath
    *   dot-separated path to requested column
    * @param codec
    *   [[ValueCodec]] required to decode the value
    * @param ordering
    ...
    */
  def min[V](columnPath: String)(implicit codec: ValueCodec[V], ordering: Ordering[V]): Option[V] =
    min(columnPath, None)
  ...
  /** @param columnPath
    ...
    */
  def max[V](columnPath: String)(implicit codec: ValueCodec[V], ordering: Ordering[V]): Option[V] =
    max(columnPath, None)

  protected[parquet4s] def min[V](columnPath: String, currentMin: Option[V])(implicit
      codec: ValueCodec[V],
      ordering: Ordering[V]
  ): Option[V]
  protected[parquet4s] def max[V](columnPath: String, currentMax: Option[V])(implicit
      codec: ValueCodec[V],
      ordering: Ordering[V]
  ): Option[V]
...
private class CompoundStats(statsSeq: Seq[Stats]) extends Stats {
  ...
  override def min[V](columnPath: String, currentMin: Option[V])(implicit
      codec: ValueCodec[V],
      ordering: Ordering[V]
  ): Option[V] =
  ...
  override def max[V](columnPath: String, currentMax: Option[V])(implicit
      codec: ValueCodec[V],
      ordering: Ordering[V]
  ): Option[V] =
...
private class LazyDelegateStats(
  ...
  override protected[parquet4s] def min[V](columnPath: String, currentMin: Option[V])(implicit
      codec: ValueCodec[V],
      ordering: Ordering[V]
  ): Option[V] =
    delegate.min(columnPath, currentMin)

  override protected[parquet4s] def max[V](columnPath: String, currentMax: Option[V])(implicit
      codec: ValueCodec[V],
      ordering: Ordering[V]
  ): Option[V] =
