...
object ParquetReader {
  ...
  private case class BuilderImpl[T](options: ParquetReader.Options = ParquetReader.Options(),
  ...
  /**
     * Creates [[Builder]] of Parquet reader returning <i>projected</i> generic records.
     * Due to projection reader does not attempt to read all existing columns of the file but applies enforced
     * projection schema.
     */
