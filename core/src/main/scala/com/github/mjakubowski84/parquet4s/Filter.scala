...
object Filter {
  ...
  def eqFilter[In, V <: Comparable[V], C <: Column[V] with SupportsEqNotEq](columnPath: String, in: In)(implicit
      codec: FilterCodec[In, V, C]
  ): Filter = new Filter {
  ...
  def neqFilter[In, V <: Comparable[V], C <: Column[V] with SupportsEqNotEq](columnPath: String, in: In)(implicit
      codec: FilterCodec[In, V, C]
  ): Filter = new Filter {
    override def toPredicate(valueCodecConfiguration: ValueCodecConfiguration): FilterPredicate =
  ...
  def gtFilter[In, V <: Comparable[V], C <: Column[V] with SupportsLtGt](columnPath: String, in: In)(implicit
      codec: FilterCodec[In, V, C]
  ): Filter = new Filter {
    override def toPredicate(valueCodecConfiguration: ValueCodecConfiguration): FilterPredicate =
  ...
  def gtEqFilter[In, V <: Comparable[V], C <: Column[V] with SupportsLtGt](columnPath: String, in: In)(implicit
      codec: FilterCodec[In, V, C]
  ): Filter = new Filter {
    override def toPredicate(valueCodecConfiguration: ValueCodecConfiguration): FilterPredicate =
  ...
  def ltFilter[In, V <: Comparable[V], C <: Column[V] with SupportsLtGt](columnPath: String, in: In)(implicit
      codec: FilterCodec[In, V, C]
  ): Filter = new Filter {
    override def toPredicate(valueCodecConfiguration: ValueCodecConfiguration): FilterPredicate =
  ...
  def ltEqFilter[In, V <: Comparable[V], C <: Column[V] with SupportsLtGt](columnPath: String, in: In)(implicit
      codec: FilterCodec[In, V, C]
  ): Filter =
    new Filter {
      override def toPredicate(valueCodecConfiguration: ValueCodecConfiguration): FilterPredicate =
  ...
  def udpFilter[In, V <: Comparable[V], C <: Column[V]](columnPath: String, udp: UDP[In])(implicit
      ordering: Ordering[In],
      codec: FilterCodec[In, V, C]
  ): Filter = new Filter {
    override def toPredicate(valueCodecConfiguration: ValueCodecConfiguration): FilterPredicate =
